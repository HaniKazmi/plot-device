 ...
 *
 * One size and one radius wherever it appears — the hover card's sheet and the expanded card's own
 * bar — because the two are the same gesture and a reader meets them on the same screen. `colour` is for a bar standing on a sampled ground, where the theme's divider is a
