...
/** The Books card, hover card and Now band answers, behind the chunk that draws them. See `vg/module.lazy.ts`. */
...
export const elect = (books: Book[]) => currentlyReading(books)[0];

export const nowPanel = (book: Book, scheme: Scheme): NowPanel => ({
