 ...
 * standing 3px high is not sampled either, the floor being nearer 12, so this one stands 15 and
 * hangs above the edge, showing the 5px that has to be on screen and no more. `visibility: hidden`
 * is not sampled at all, so there is no drawing it and hiding it.
 *
