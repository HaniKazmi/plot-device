 ...
 */
export const platformToShort: (game: VideoGame) => [string, Colour] = (game) => {
  const short = platformShortNames[game.platform];
  if (!short) throw new Error("Unknown platform: " + game.platform);
